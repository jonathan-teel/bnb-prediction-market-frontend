    ...
    <div className="px-[50px] flex-col 2xl:flex-row self-stretch inline-flex justify-start items-start gap-[50px] overflow-auto relative">
      <div className="flex-1 p-8 bg-[#1a1f26] rounded-2xl border border-[#1f242c] inline-flex flex-col justify-center items-center gap-8 relative">
        ...
        <div className="self-stretch flex flex-col justify-start items-start gap-2">
          ...
          <div className="justify-start text-[#9EA5B5] text-lg font-medium font-satoshi leading-relaxed">
        ...
        <div className="self-stretch flex flex-col gap-8">
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="flex flex-col gap-4 lg:w-1/4">
              ...
              <div className="flex flex-col gap-2">
                <label className="w-full h-[200px] bg-[#0b0e11] rounded-2xl cursor-pointer border-2 border-dashed border-[#313131] flex flex-col justify-center items-center gap-4 relative hover:bg-[#181a1a] transition-colors shadow-lg">
                  {previewUrl && (
                    <img
                      src={previewUrl}
                      alt="Preview"
                  ...
                  <FiUpload size={28} color="#FCD535" />
                  <div className="text-[#9EA5B5] text-base font-medium text-center px-4">
                    <input
                      type="file"
                      accept="image/*"
                ...
                <div className="text-[#9EA5B5] text-xs">*File format jpg, png, img. max size 5mb</div>
            ...
            <div className="flex flex-col gap-8 lg:w-3/4">
              ...
              <div className="flex flex-col gap-4 relative">
                ...
                <button 
                  className="w-full text-[#9EA5B5] px-4 py-3.5 text-lg font-medium bg-[#0b0e11] rounded-2xl border border-[#1f242c] flex justify-between items-center hover:bg-[#15191f] transition-colors" 
                ...
                {marketFieldOpen && (
                  <div id="market_catagory" className="w-full bg-[#0b0e11] rounded-2xl outline-1 outline-offset-[-1px] absolute left-0 bottom-[-100px] z-10 outline-[#313131]">
                    {marketField.map((field, index) => (
                      <div
                        key={"market-field-" + index }
                        className="px-4 py-3 hover:bg-[#15191f] cursor-pointer transition-colors text-white"
                        onClick={() => {
              ...
              {marketField[marketFieldIndex].name === "Sports Prediction Market" ? (
                <div className="space-y-4">
                  ...
                  <div className="relative">
                    {/* <div className="text-[#9EA5B5] text-lg mb-2">Select Sport</div> */}
                    <button 
                      className="w-full text-[#9EA5B5] px-4 py-3.5 text-lg font-medium bg-[#0b0e11] rounded-2xl border border-[#1f242c] flex justify-between items-center hover:bg-[#15191f] transition-colors" 
                    ...
                    {sportOpen && (
                      <div className="absolute z-10 w-full mt-1 bg-[#0b0e11] rounded-2xl border border-[#1f242c] shadow-lg">
                ...
                <div className="flex flex-col gap-4 relative">
                  ...
                  {marketFieldContentOpen && (
                    <div className="w-full bg-[#0b0e11] rounded-2xl outline-1 outline-offset-[-1px] absolute left-0 bottom-[-100px] z-10 outline-[#313131]">
          ...
          <div className="flex flex-col gap-8">
            ...
            <motion.div
              ...
              className="flex flex-col gap-4 p-8 bg-gradient-to-br from-[#12161f] to-[#1e2329] rounded-3xl border border-[#FCD535]/30 shadow-xl relative overflow-hidden group"
            >
              {/* Rippling effect overlay */}
              <div className="absolute inset-0 bg-gradient-to-r from-transparent via-[#FCD535]/10 to-transparent translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-1000 ease-in-out" />
              <motion.div
              ...
              >
                <GoQuestion size={28} className="text-[#FCD535]" />
              ...
              <motion.div
                ...
                className="text-[#FCD535] text-xl font-semibold drop-shadow-lg"
              >
                {marketField[marketFieldIndex].name === "Sports Prediction Market" ? (
                  selectedTeam ? (
            ...
            {marketField[marketFieldIndex].name === "Sports Prediction Market" && selectedSport && (
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="flex flex-col gap-6">
                  {/* League Selection */}
                  <div className="relative">
                    <div className="text-[#9EA5B5] text-lg mb-2">Select League</div>
                    <button 
                      className="w-full text-[#9EA5B5] px-4 py-3.5 text-lg font-medium bg-[#0b0e11] rounded-2xl border border-[#1f242c] flex justify-between items-center hover:bg-[#15191f] transition-colors" 
                    ...
                    {leagueOpen && (
                      <div className="absolute z-10 w-full mt-2 bg-[#0b0e11] rounded-2xl border border-[#1f242c] shadow-lg">
                  ...
                  <div className="relative">
                    <div className="text-[#9EA5B5] text-lg mb-2">Select Team</div>
                    <button 
                      className={`w-full text-[#9EA5B5] px-4 py-3.5 text-lg font-medium bg-[#0b0e11] rounded-2xl border border-[#1f242c] flex justify-between items-center transition-colors ${!selectedLeague ? 'opacity-50 cursor-not-allowed' : 'hover:bg-[#15191f] cursor-pointer'}`}
                ...
                <div className="flex flex-col gap-6">
                  ...
                  <div className="flex flex-col gap-2">
                    <div className="text-[#9EA5B5] text-lg">Prediction Type</div>
                    <div className="flex gap-4">
                      <button
                        className={`flex-1 px-4 py-3.5 text-lg font-medium rounded-2xl border border-[#1f242c] transition-colors ${
                          selectedStatType === "points"
                            ? "bg-[#FCD535] text-[#111111]"
                            : !selectedTeam ? 'opacity-50 cursor-not-allowed' : 'bg-[#0b0e11] text-[#9EA5B5] hover:bg-[#15191f] cursor-pointer'
                        }`}
                  ...
                  <div className="flex flex-col gap-2">
                    <div className="text-[#9EA5B5] text-lg">Prediction</div>
                    <div className="flex gap-4">
                      <button
                        className={`flex-1 px-4 py-3.5 text-lg font-medium rounded-2xl border border-[#1f242c] transition-colors ${
                          predictionOutcome === "win"
                            ? "bg-[#FCD535] text-[#111111]"
                            : selectedStatType !== "next_game" ? 'opacity-50 cursor-not-allowed' : 'bg-[#0b0e11] text-[#9EA5B5] hover:bg-[#15191f] cursor-pointer'
                        }`}
                  ...
                  <div className="flex flex-col gap-2">
                    <div className="text-[#9EA5B5] text-lg">Target Points</div>
                    <input
                      type="number"
                      className={`w-full px-4 py-3.5 text-[#9EA5B5] text-lg font-medium bg-[#0b0e11] rounded-2xl border border-[#1f242c] hover:bg-[#15191f] transition-colors ${selectedStatType !== "points" ? 'opacity-50 cursor-not-allowed' : ''}`}
            ...
            {marketField[marketFieldIndex].name !== "Sports Prediction Market" && (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="flex flex-col gap-6">
                  <div className="flex flex-col gap-2">
                    <div className="text-[#9EA5B5] text-lg font-semibold">Token Ticker</div>
                    <div className="relative">
                      <input
                        type="text"
                        className="w-full px-4 py-3.5 text-[#9EA5B5] text-lg font-medium bg-[#12161f] rounded-2xl border border-[#1e2329] focus:border-[#FCD535] outline-none transition-all"
                      ...
                      />
                      {tokenDropdownOpen && (
                        <div className="absolute z-10 w-full mt-2 max-h-60 overflow-y-auto bg-[#12161f] rounded-2xl border border-[#1e2329] shadow-lg">
                          {tokenList
                            .filter(token =>
                            ...
                            .map(token => (
                              <div
                                key={token.id}
                                className="px-4 py-3 hover:bg-[#1e2329] cursor-pointer text-white"
                                onClick={() => {
                              ...
                              >
                                <span className="font-bold">{token.symbol.toUpperCase()}</span> <span className="text-[#9EA5B5]">{token.name}</span>
                              </div>
                            ))}
                          {tokenList.filter(token =>
                            ...
                            <div className="px-4 py-3 text-[#9EA5B5]">No tokens found</div>
                          )}
                        </div>
                      )}
                    </div>
                  ...
                  {selectedToken && (
                    <div className="flex flex-col gap-1 mt-2">
                      <Link
                        ...
                        className="text-[#FCD535] underline text-base font-medium hover:text-[#FCD535] transition-colors float-left"
                      >
                        View on CoinGecko
                      </Link>
                      <div className="text-[#9EA5B5] text-xs">CoinGecko ID: <span className="font-mono">{selectedToken.id}</span></div>
                    </div>
                  )}
                  {market.length > 0 &&
                    ( 
                      <div className="flex flex-col gap-4 relative">
                        ...
                        <button 
                          className="w-full text-[#9EA5B5] px-4 py-3.5 text-lg font-medium bg-[#12161f] rounded-2xl border border-[#1f242c] flex justify-between items-center hover:bg-[#15191f] transition-colors" 
                ...
                <div className="flex flex-col gap-6">
                  <div className="flex flex-row gap-4">
                    <div className="flex-1 flex flex-col gap-2">
                      <div className="text-[#9EA5B5] text-lg font-semibold">Target Value</div>
                      <input
                        type="number"
                        className="w-full px-4 py-3.5 text-[#9EA5B5] text-lg font-medium bg-[#12161f] rounded-2xl border border-[#1e2329] focus:border-[#FCD535] outline-none transition-all"
                    ...
                    <div className="flex-1 flex flex-col gap-2">
                      <div className="text-[#9EA5B5] text-lg font-semibold">Resolution Date</div>
                      <input
                        type="date"
                        className="w-full px-4 py-3.5 text-[#9EA5B5] text-lg font-medium bg-[#12161f] rounded-2xl border border-[#1e2329] focus:border-[#FCD535] outline-none transition-all"
                        name="date"
                  ...
                  <div className="flex flex-col gap-2 mt-2">
                    <div className="text-[#9EA5B5] text-lg font-semibold">Prediction Type</div>
                    <div className="flex gap-4">
                      <button
                        className={`flex-1 px-4 py-3.5 text-lg font-semibold rounded-2xl border border-[#1e2329] transition-colors ${
                          data.range === 0
                            ? "bg-[#FCD535] text-[#12161f] border-[#FCD535] shadow"
                            : "bg-[#12161f] text-[#9EA5B5] hover:bg-[#1e2329]"
                        }`}
            ...
            <div className="flex flex-col gap-2 mt-6">
              <div className="text-[#9EA5B5] text-lg font-semibold">Description</div>
              <textarea
                rows={6}
                className="w-full px-4 py-3.5 text-[#9EA5B5] text-lg font-medium bg-[#12161f] rounded-2xl border border-[#1e2329] focus:border-[#FCD535] outline-none transition-all resize-none"
            ...
            <div className="flex flex-col gap-6 mt-4">
              ...
              <div className="flex items-center gap-2">
                ...
                />
                <div className="text-[#9EA5B5] text-lg">
                  I agree to the{" "}
                  <span className="text-[#FCD535] underline cursor-pointer">
                    Terms & Conditions
                  </span>
                </div>
              </div>
              ...
              {/* Submit Button */}
              <button
                className="w-full px-6 py-4 text-xl font-medium text-[#111111] bg-[#FCD535] rounded-2xl shadow-[inset_0px_3px_0px_0px_rgba(255,255,255,0.16)] hover:bg-[#FFD166] transition-all duration-200 ease-in-out transform hover:scale-[1.02] active:scale-[0.98]"
                onClick={onSubmit}
              >
                Create Market
              </button>
