            ...
            <div className="flex-1 h-[100px] flex justify-end items-center gap-1">
              <div className="px-3 py-1 rounded-[100px] border border-[#1f242c] flex justify-start items-center gap-1">
                <div className="w-6 h-6 relative overflow-hidden">
                  ...
                  <div className="w-[9px] h-2 left-[14px] top-[8px] absolute bg-[#9EA5B5]" />
          ...
          <div className="self-stretch inline-flex justify-start items-start gap-4">
            <div className="flex-1 inline-flex flex-col justify-start items-start gap-4">
              ...
              <div className="flex flex-col justify-start items-start gap-1">
                ...
                <div className="self-stretch justify-start text-white text-xl font-medium font-satoshi leading-relaxed">
                  {profileData? parseFloat(Number(profileData.totalLiquidityProvided).toFixed(9)).toString() : 0} BNB
                </div>
              </div>
            </div>
            <div className="flex-1 inline-flex flex-col justify-start items-start gap-4">
              <div className="flex flex-col justify-start items-start gap-1">
                ...
                <div className="self-stretch justify-start text-white text-xl font-medium font-satoshi leading-relaxed">
                  {profileData? parseFloat(Number(profileData.earnedFeeLiquidity / 1000000000).toFixed(9)).toString() : 0} BNB
                </div>
              </div>
              <div className="flex flex-col justify-start items-start gap-1">
                <div className="self-stretch justify-start text-[#9EA5B5] text-lg font-medium font-satoshi leading-relaxed">
        ...
        {activeTab === "Betting History" && (
          <>
            ...
            <div className="self-stretch px-4 py-2 bg-[#1a1f26] rounded-2xl border border-[#1f242c] inline-flex justify-start items-center gap-3">
              ...
              <div className="flex-1 justify-center text-[#9EA5B5] text-base font-medium font-satoshi leading-none">
                Name
              </div>
              <div className="w-[100px] justify-center text-[#9EA5B5] text-base font-medium font-satoshi leading-none">
                Status
              </div>
              <div className="w-[100px] justify-center text-[#9EA5B5] text-base font-medium font-satoshi leading-none">
                Odds
