      ...
      <div className="grid grid-cols-2 gap-6">
        ...
        >
          <div className="flex items-center gap-3 mb-2">
            <FaUserFriends className="text-[#FCD535] text-xl" />
            <h3 className="text-white text-lg font-medium">Active Referrals</h3>
          </div>
          <p className="text-[#FCD535] text-2xl font-bold">{referral?.length}</p>
        </motion.div>
        <motion.div 
          whileHover={{ scale: 1.02 }}
          className="p-6 bg-gradient-to-r from-[#191d23] to-[#1f242c] rounded-xl border border-[#313131]"
        >
          <div className="flex items-center gap-3 mb-2">
            <FaCoins className="text-[#FCD535] text-xl" />
            <h3 className="text-white text-lg font-medium">Total Earnings</h3>
          </div>
          <div className="flex items-center gap-2">
            <p className="text-[#FCD535] text-2xl font-bold"></p>
            <span className="text-[#FCD535] text-2xl font-bold">{referral?.reduce((sum, i) => sum + i.fee, 0)} BNB</span>
          </div>
        </motion.div>
      </div>
